//
//  StoryVeryHungryCaterpillar.swift
//  Sleep
//
...
struct StoryVeryHungryCaterpillar: View {
    // MARK: - Properties
    ...
    private func setupAudioPlayer() {
        if let url = Bundle.main.url(forResource: "very_hungry_caterpillar", withExtension: "mp3") {

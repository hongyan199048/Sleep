...
struct StoryRabbitWantsToSleep: View {
    // MARK: - Properties
    ...
    private func setupAudioPlayer() {
        if let url = Bundle.main.url(forResource: "rabbit_wants_to_sleep", withExtension: "mp3") {

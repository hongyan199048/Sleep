...
struct StoryLittleBlueYellow: View {
    // MARK: - Properties
    ...
    private func setupAudioPlayer() {
        if let url = Bundle.main.url(forResource: "little_blue_yellow", withExtension: "mp3") {

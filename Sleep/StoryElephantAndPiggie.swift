...
struct StoryElephantAndPiggie: View {
    // MARK: - Properties
    ...
    private func setupAudioPlayer() {
        if let url = Bundle.main.url(forResource: "elephant_and_piggie", withExtension: "mp3") {
